...
- (void)initImageView:(float)xt andHeight:(int)xh;
{
    ...
    imageView.frame = CGRectMake(0, 0, MRScreenWidth * xt, xh*xt);
...
//    NSLog(@"%f %f %f", xt, MRScreenWidth * xt, xh*xt);
  
    [self setZoomScale:xt];
